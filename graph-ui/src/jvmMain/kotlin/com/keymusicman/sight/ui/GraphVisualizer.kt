package com.keymusicman.sight.ui
...
import com.keymusicman.sight.viewmodel.GraphViewModel
...
private fun AsyncImage(
    ...
    LaunchedEffect(contentDescription) {
        try {
            ...
            Logger.w { "[Sight] AsyncImage: failed to load '$contentDescription': ${e::class.simpleName}: ${e.message}" }
            error = e
        }
    }
