...
import com.keymusicman.sight.model.ScreenDef
import com.keymusicman.sight.model.TransitionDef
...
class GraphAggregatorTest {
    ...
    private fun frag(
        ...
        transitions: List<com.keymusicman.sight.model.TransitionDef> = emptyList(),
    ) = com.keymusicman.sight.model.GraphFragment(module, modulePath, graphs, screens, transitions)
