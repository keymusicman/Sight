...
import io.github.keymusicman.sight.model.ScreenDef
import io.github.keymusicman.sight.model.TransitionDef
...
class GraphAggregatorTest {
    ...
    private fun frag(
        ...
        transitions: List<io.github.keymusicman.sight.model.TransitionDef> = emptyList(),
    ) = io.github.keymusicman.sight.model.GraphFragment(module, modulePath, graphs, screens, transitions)
    ...
    fun functionToScreenInSameSubgraphConnects() {
        ...
        // wired by a function-level @SightTransition(toScreen = "ReferralProgramDetailsBottomSheet").
        val r = GraphAggregator.aggregate(listOf(frag(
            screens = listOf(
                ScreenDef(subgraph = "main", id = "MainScreen", is_root = true, composable_fqn = "P.MainScreen"),
