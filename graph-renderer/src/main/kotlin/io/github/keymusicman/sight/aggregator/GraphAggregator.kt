...
import io.github.keymusicman.sight.model.Connection
import io.github.keymusicman.sight.model.ConnectionEndpoint
import io.github.keymusicman.sight.model.GraphDef
import io.github.keymusicman.sight.model.GraphFragment
import io.github.keymusicman.sight.model.GraphMetadata
import io.github.keymusicman.sight.model.NamedGraph
import io.github.keymusicman.sight.model.Screen
import io.github.keymusicman.sight.model.Subgraph
import io.github.keymusicman.sight.model.filterToView
...
object GraphAggregator {
    ...
    internal data class MergedGraphDef(
        ...
        val transitions: List<io.github.keymusicman.sight.model.TransitionDef>,
    )
    ...
    private fun resolveGraphTransitions(
        transitions: List<io.github.keymusicman.sight.model.TransitionDef>,
        pool: Map<Pair<String, String>, PooledScreen>,
        errors: MutableList<String>,
        warnings: MutableList<String>,
    ): List<ResolvedConn> {
