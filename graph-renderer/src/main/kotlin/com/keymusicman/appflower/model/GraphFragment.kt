...
/** A `@AppFlowGraph` declaration. `name` blank means the default graph. */
@Serializable
data class GraphDef(
    val name: String = "",
...
/** A `@AppFlowScreen` declaration. Blank `subgraph` means the default subgraph. */
@Serializable
...
/** A `@AppFlowTransition`. `source_fqn == null` means it was declared on a graph object. */
@Serializable
